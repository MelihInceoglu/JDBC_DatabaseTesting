...
public class JDBC_Query01 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //5.Adim DataBASE BAGLANTİSİNİ KAPAT
        resultSet.close();
        statement.close();
        connection.close();
        ...
        // Database baglantisi kurulurken gerceklestirilen sira (connection > statement > resultset) database naglantisi kapatilirken
        // tersten isleme tabii tutulur(resultSet > statement > connection)
        // JDBC SON! finita la musica
